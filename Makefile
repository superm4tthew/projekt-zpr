...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sun Jun 3 23:27:33 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/projekt-zpr1.0.0/ && $(COPY_FILE) --parents headers/Curve.h headers/fileProxy.h headers/FunctionData.h headers/Panel.h headers/Plot.h headers/PlotWindow.h .tmp/projekt-zpr1.0.0/ && $(COPY_FILE) --parents application.qrc .tmp/projekt-zpr1.0.0/ && $(COPY_FILE) --parents sources/Curve.cpp sources/fileProxy.cpp sources/FunctionData.cpp sources/main.cpp sources/Panel.cpp sources/Plot.cpp sources/PlotWindow.cpp .tmp/projekt-zpr1.0.0/ && (cd `dirname .tmp/projekt-zpr1.0.0` && $(TAR) projekt-zpr1.0.0.tar projekt-zpr1.0.0 && $(COMPRESS) projekt-zpr1.0.0.tar) && $(MOVE) `dirname .tmp/projekt-zpr1.0.0`/projekt-zpr1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/projekt-zpr1.0.0
...
FunctionData.o: sources/FunctionData.cpp headers/FunctionData.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FunctionData.o sources/FunctionData.cpp
